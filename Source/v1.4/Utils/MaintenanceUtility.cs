    ...
    public class MaintenanceUtility
    {
        ...
        public static LocalTargetInfo FindMaintenanceSpot(Pawn pawn)
        {
            ...
            foreach (LocalTargetInfo item in tmep)
            {
                ...
                if (item.Thing != null && item.Thing is Building building && building.def == BF_ThingDefOf.BF_MaintenanceSpot)
                {
        ...
        public static IEnumerable<LocalTargetInfo> AllMaintenanceSpotCandidates(Pawn pawn)
        {
            ...
            {
                foreach (Building item in pawn.Map.listerBuildings.AllBuildingsColonistOfDef(BF_ThingDefOf.BF_MaintenanceSpot))
                {
                    yield return item;
                }
            }
