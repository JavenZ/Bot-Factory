...
{
    public class BotFactory : Mod
    {
        public static BotFactory_Settings settings;
        public static BotFactory ModSingleton { get; private set; }
    ...
    public static class BotFactory_PostInit
    {
