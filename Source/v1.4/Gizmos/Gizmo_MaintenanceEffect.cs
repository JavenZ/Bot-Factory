    ...
    public class Gizmo_MaintenanceEffect : Gizmo
    {
        ...
        public override GizmoResult GizmoOnGUI(Vector2 topLeft, float maxWidth, GizmoRenderParms parms)
        {
            ...
            Find.WindowStack.ImmediateWindow(137486536, overRect, WindowLayer.GameUI, delegate
            {
                ...
                Widgets.Label(firstRect, "BF_MaintenanceEffectGizmoLabel".Translate(maintenanceNeed.maintenanceEffectTicks < 0 ? "BF_MaintenanceEffectGizmoLabelNegative".Translate() : "BF_MaintenanceEffectGizmoLabelPositive".Translate(), Mathf.RoundToInt(Mathf.Abs(maintenanceNeed.maintenanceEffectTicks / 60000))));
                ...
                TooltipHandler.TipRegion(secondRect, () => "BF_MaintenanceEffectDesc".Translate(), Gen.HashCombineInt(maintenanceNeed.GetHashCode(), 283641));
            });
